...
export default function PostDeliveryCard ({idDelivery, pickUpLocation, deliveryLocation, deliveryHour, deliveryTitle, posterName, price, bottomText, isSelected }) {
    const theme = useTheme();
    return (
        <>
        {bottomText? (
            <OutContainer color={theme.colors.secondaryLight}>
                <ContainerGeneral>
            ...
            <ContainerGeneral color={isSelected? theme.colors.secondaryLight: 'transparent'}>
            <FlexContainer width={"75%"} height="100%" direction="column" gap="2px">
                <FlexContainer height="auto" direction="row" alignitems="center" gap="5px" className='mb-2'>
                    <Icon as={RunnerIcon}></Icon>
                    <Icon as={Next} width="5px"></Icon>
            ...
            <FlexContainer direction="column" alignitems="flex-end" gap="3px" width="auto">
                <TextCard color={theme.colors.foreground} weight="500" size="16px">{deliveryHour }</TextCard>
                <TextCard color={theme.colors.secondaryText} weight="400" size="12px">{bottomText}</TextCard>
