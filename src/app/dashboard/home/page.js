    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        if (response) {
          ...
          setPosts(post);
          console.log("posts", postRunner);
          setPostRunner(postRunner);
      ...
      <FlexContainer className="p-5" direction="column" gap="30px">
        <FlexContainer direction="row">
          <FlexContainer direction="column">
            ...
            <Paragraph
              text="Bienvenido a U-mandaditos"
        ...
        <Card>
          <FlexContainer direction="column" width="70%" gap="1px">
            ...
            <Paragraph
              text="Siéntate y encuentra el mejor runner."
              size="10px"
              color={theme.colors.secondaryText}
            />
            <Button
        ...
        <FlexContainer direction="column" gap="5px">
          <Title
            text="Encuentra mandaditos cerca de ti"
            weight="450"
            size="20px"
            className="mb-2"
          />
          <img
            src="/img/img-map.png"
            alt="Mapa de mandaditos"
            onClick={() => {
              router.push("/dashboard/mandaditos/search");
            }}
          />
        </FlexContainer>
      </FlexContainer>
